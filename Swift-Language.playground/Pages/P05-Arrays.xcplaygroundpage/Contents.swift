...
var lifeOnTheFarmIsHard = ["wake up", "wash the dishes", "milk the cows"]

lifeOnTheFarmIsHard.append("churn the butter")
lifeOnTheFarmIsHard = lifeOnTheFarmIsHard + ["call the cows"]
print(lifeOnTheFarmIsHard[0])
var currentTask = 0
print(lifeOnTheFarmIsHard[currentTask])
currentTask = currentTask + 1
print(lifeOnTheFarmIsHard[currentTask])
lifeOnTheFarmIsHard.insert("feed the chickens", atIndex: 2)
currentTask = currentTask + 1
print(lifeOnTheFarmIsHard[currentTask])
print(lifeOnTheFarmIsHard)
