...
instructions["slavik"] = "Horbach"
instructions["joe"] = "Surname"
instructions["scott"] = "AnotherSurname"
if instructions["slavik"] != nil {
    print(instructions["slavik"])
}

instructions["scott"]!

if instructions["blah"] != nil {
    print(instructions["blah"])
}
