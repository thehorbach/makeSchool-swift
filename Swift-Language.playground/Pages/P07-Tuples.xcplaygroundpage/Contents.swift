...
var usd = (currency: "usd", value: 1.0)
var cad = (currency: "cad", value: usd.value * 1.29)
var aud = (currency: "aud", value: usd.value * 1.36)

print("\(usd.value) \(usd.currency) is \(cad.value) \(cad.currency)")
